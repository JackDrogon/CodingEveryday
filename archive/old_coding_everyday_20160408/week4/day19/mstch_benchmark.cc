...
static void basic_usage(benchmark::State &state)
{
	...
	auto comment_view = mstch::map{
	    ...
	    {"comments",
	     mstch::array{
		 mstch::map{{"name", std::string{"Joe"}},
			    {"body", std::string{"Thanks for this post!"}}},
		 mstch::map{{"name", std::string{"Sam"}},
			    {"body", std::string{"Thanks for this post!"}}},
		 mstch::map{{"name", std::string{"Heather"}},
			    {"body", std::string{"Thanks for this post!"}}},
		 mstch::map{{"name", std::string{"Kathy"}},
			    {"body", std::string{"Thanks for this post!"}}},
		 mstch::map{{"name", std::string{"George"}},
			    {"body", std::string{"Thanks for this post!"}}}}}};
